...
python -m py_compile scripts/experiment_utils.py scripts/train_parkour.py scripts/evaluate_model.py scripts/watch_model.py
python -m pytest
...
`scripts.run_experiment.py` is currently deferred; use `train_parkour` plus `evaluate_model` for the smoke path.
